...
namespace RulesEngine
{
    public class ValidationReport : IValidationReport
    {
        ...
        public ValidationReport(Engine engine)
        {
        ...
        {
            return GetErrorMessage(value, new EquatableExpression(expression), GetEngine().DefaultErrorResolver);
        }
        ...
        {
            return GetErrorMessages(GetEngine().DefaultErrorResolver);
        }
        ...
        {
            if (value == null) throw new System.ArgumentNullException("value");
            return GetErrorMessages(value, GetEngine().DefaultErrorResolver);
        }
